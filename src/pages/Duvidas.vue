        ...
        <div class="wysiwyg w-full md:w-10/12 lg:w-8/12">
          <ol>
            <li>
              ...
              <p>
                Entre um módulo e outro, haverá uma semana em que Morgenstern
                responderá às perguntas dos alunos em uma aula ao vivo. Nesta
                semana não haverá vídeos novos. As aulas retornam na semana
                seguinte.
              </p>
            </li>
